...
class DetailedMainActivity : AppCompatActivity() {
    ...
    private lateinit var  newArrayList: ArrayList<Detailed>
     lateinit var imageId : Array<Int>     // 수형 영상
     lateinit var heading : Array<String>  //한국어 대응 표현
     lateinit var explain : Array<String>  //수형 설명
    lateinit var imageId2 : Array<Int>  //수형사진
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       adapter.setOnItemClickListener(object : DetailedAdapter.onItemClickListener{
           override fun onItemClickListener(position: Int) {
               ...
               val intent = Intent(this@DetailedMainActivity, VideoMainActivity::class.java)
