...
class ContentMainActivity : AppCompatActivity() {
    ...
    private fun init(){
        ...
        addDataToList(2)  //value 2-> 일상. 3-> 전문
    ...
    private fun addDataToList(value: Int) {
       ...
       contentList.add(Content(R.drawable.aniaml, "동식물"))
        ...
        if(value==3)
        {contentList.add(Content(R.drawable.laww, "법률"))
        contentList.add(Content(R.drawable.ic_baseline_directions_car_24, "교통"))
        contentList.add(Content(R.drawable.hospital, "의학"))
        contentList.add(Content(R.drawable.info, "정보통신"))
        contentList.add(Content(R.drawable.budhhsm, "불교"))
        contentList.add(Content(R.drawable.catholic, "천주교"))
        contentList.add(Content(R.drawable.church, "기독교"))
        contentList.add(Content(R.drawable.korean, "국어 교과 용어"))
        contentList.add(Content(R.drawable.eco, "경제"))
        contentList.add(Content(R.drawable.nation, "정치"))}
    }
